...
3. Mount the phone, use the rear camera, frame the road in the preview, and tap **Start sending**. The app saves the crop first, then publishes to `rtmp://VAST_IP:40097/phone` automatically.
